...
export default function DashboardPage() {
    ...
    const isReviewer = user && canApproveEvidence(user.role);
            ...
            <div className="container mx-auto py-8">
                <div className="flex justify-between items-center mb-8">
                    <div>
                        ...
                        <p className="text-slate-500">ยินดีต้อนรับ, {user?.displayName} ({user?.role})</p>
                    </div>
                    <Link href="/profile">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                    ...
                    <Card>
                        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                            <CardTitle className="text-sm font-medium">ความคืบหน้าโดยรวม</CardTitle>
                            <CheckCircle2 className="h-4 w-4 text-muted-foreground" />
                        </CardHeader>
                        <CardContent>
                            <div className="text-2xl font-bold">0%</div>
                            <p className="text-xs text-muted-foreground">ยังไม่มีการส่งข้อมูล</p>
                        </CardContent>
                    </Card>
